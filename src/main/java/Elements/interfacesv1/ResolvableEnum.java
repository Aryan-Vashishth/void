...
public interface ResolvableEnum extends KeyValuePair<String,String> {
    ...
    default java.util.Map<Elements.ElementRole,String> getAllLocatorRoles(){
        java.util.Map<Elements.ElementRole,String> roles = new java.util.LinkedHashMap<>();
        String primary = getPrimaryLocator();
        if(primary!=null && !primary.isBlank()) roles.put(Elements.ElementRole.TEXT, primary);
        return roles;
    }
}
