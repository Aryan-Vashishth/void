 ...
 */
public interface ToolTipElement extends ReadOnlyElement {
    ...
    default java.util.Map<ElementRole,String> getAllLocatorRoles(){
        java.util.Map<ElementRole,String> roles = new java.util.LinkedHashMap<>(ReadOnlyElement.super.getAllLocatorRoles());
