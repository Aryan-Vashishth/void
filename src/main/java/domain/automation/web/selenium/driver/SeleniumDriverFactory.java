 ...
 * </ul>
 *
 * <p>Lifecycle is not managed here. Pair with your thread-safe context (e.g., {@code SeleniumDriverContext}).</p>
...
public final class SeleniumDriverFactory {
    ...
    public static Builder fromProfile(Profile profile) {
        debug.log("SeleniumDriverFactory.fromProfile(): " + profile);
    ...
    public static Builder fromConfigClasspath(String resourcePath) {
        debug.log("SeleniumDriverFactory.fromConfigClasspath(): " + resourcePath);
    ...
    public static Builder fromConfigFile(Path path) {
        debug.log("SeleniumDriverFactory.fromConfigFile(): " + path);
    ...
    public static Path createPropertiesTemplate(Path path,
        ...
        try {
            ...
            info.log("SeleniumDriverFactory properties template written to: " + path.toAbsolutePath());
            return path;
        } catch (Exception e) {
    ...
    public static String getTemplateString(boolean includeComments, boolean includeExamples, boolean fillDefaults) {
        ...
        if (includeComments) {
            sb.append("# SeleniumDriverFactory Properties Template").append(nl)
    ...
    public static final class Builder {
        ...
        public WebDriver build() {
            debug.log("SeleniumDriverFactory.Builder.build(): browser=" + browser + ", remote=" + remote + ", headless=" + headless);
            ...
            debug.log("SeleniumDriverFactory.Builder.build(): WebDriver created.");
            return driver;
        }
