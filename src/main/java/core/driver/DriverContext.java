 ...
 * Typical usage:
 * <pre>
 *   DriverContext.setDriver(new ChromeDriver()); // PRIMARY
 *   DriverContext.setSecondaryDriver(new FirefoxDriver());
 *
 *   WebDriver driver = DriverContext.getDriver();              // PRIMARY
 *   WebDriver secondary = DriverContext.getSecondaryDriver();  // SECONDARY
 *
 *   DriverContext.setActive("secondary");
 *   WebDriver active = DriverContext.getActiveDriver();        // returns secondary
 *
 *   DriverContext.quitAllDrivers(); // cleanup
 * </pre>
 */
