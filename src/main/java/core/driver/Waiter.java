 ...
 * active {@link DriverContext} driver.
 *
...
public final class Waiter {
    ...
    public static WebDriverWait get() {
        return new WebDriverWait(DriverContext.getDriver(), Duration.ofSeconds(DEFAULT_TIMEOUT_SEC));
    }
    ...
    public static WebDriverWait get(int timeoutSeconds) {
        return new WebDriverWait(DriverContext.getDriver(), Duration.ofSeconds(timeoutSeconds));
    }
}
