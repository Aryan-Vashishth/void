...
public class DataVerifier {
    ...
    private DataVerifier() { /* static utility */ }
    ...
    // VerifyCurrentPage and VerifyManageUsers have been moved to Info.VerifyPage
    // and Info.ManageUsersInfo.verify() — DataVerifier is now pure data comparison with no UI deps.
}
