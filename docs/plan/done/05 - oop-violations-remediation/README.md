...
**Status:** Complete -- all phases implemented (2026-07-23)
...
| 3 | `phase-3-dsl-dispatch.md` | P2 | Replace `instanceof` chains in `VoidDSL` with `element.capability()` enum comparison |
...
- `audit/phase-4-p8-engine-decoupling-dependency-check.md` -- prerequisite check for P8

## Decisions

ADRs produced during this initiative:
