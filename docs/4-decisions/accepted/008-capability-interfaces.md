...
- [System Overview](../architecture/system-overview.md) — full capability table
- [Quick Start Guide](../architecture/quick-start.md) — defining elements with capabilities
