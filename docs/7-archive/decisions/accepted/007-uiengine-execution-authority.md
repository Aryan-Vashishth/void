...
- [Experiment: Multi-Engine Execution](../../experiments/2026-05-01-multi-engine-execution.md) — design vision and roadmap
- [Outcome: Interaction–Execution Separation](../../../3-review/2026-06-interaction-execution-separation.md) — implementation details
